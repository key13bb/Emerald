...
import star.key13bb.emerald.gtfs.GTFSManager


val manager = getContext().getSystemService(Context.CONNECTIVITY_SERVICE) as ConnectivityManager
...
fun DownloadPrimaryDialog() {
    Column {
        ...
        Text(getContext().filesDir.path)
        Text(getContext().cacheDir.path)
    }
}
